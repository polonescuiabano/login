...
<body>
    <div class="mdc-typography">
        ...
        <a href="<?php echo e(url('auth/discord')); ?>" class="mdc-button mdc-button--raised">Login com Discord</a>
    </div>
    <script src="https://cdn.jsdelivr.net/npm/material-components-web/dist/material-components-web.min.js"></script>
</body>
</html>
<?php /**PATH C:\Users\Dell\Documents\server\resources\views/welcome.blade.php ENDPATH**/ ?>